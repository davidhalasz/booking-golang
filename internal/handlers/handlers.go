...
import (
	...
	"github.com/davidhalasz/go-bookings/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "cannot get parse start date")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "cannot get parse end date")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
...
func (m *Repository) AdminShowReservation(w http.ResponseWriter, r *http.Request) {
	// localhost:8080/admin/reservations/new/20
	exploded := strings.Split(r.RequestURI, "/")
	// [localhost:8080, admin, reservations, new. 20]
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// add to the session...session init is on the main file
